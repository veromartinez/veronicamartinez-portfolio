...
export default function CCNWhastapp() {
  return (
    <div className="case-study">
      ...
      <CaseImageGrid
        images={['/images/case-studies/ccn-whatsapp/01-whastapp-1120px.jpg']}
        alts={['Conversación del asistente virtual de fidelización por WhatsApp']}
      />
...
Explícitamente nos pidió que no se debía parecer a ninguno de los que había en su país porque la experiencia era mala y los usuarios solían evitarlos, y no querían que eso afectara la experiencia y la confianza en la marca que están construyendo.`}
      ...
      <CaseImageGrid
        ...
        alts={[
          'Flujo conversacional del programa de fidelización en WhatsApp',
          'Escalamiento a agente humano en el asistente de WhatsApp',
        ]}
      />
...
- Diseñamos la lógica de escalamiento para dirigir rápidamente las solicitudes sin resolver a agentes humanos.`}
      ...
      <CaseImageGrid
        images={['/images/case-studies/ccn-whatsapp/02-whastapp-1120px.jpg']}
        alts={['Personalidad y tono de marca del asistente virtual']}
      />

      <CaseAprendizajes text={`Diseñar para la IA implica diseñar para la ambigüedad. Nunca responde dos veces igual. Muchas veces ni siquiera responde lo que yo diseñé, pero aprendí que lo que responde cuando no sabe es tan importante como todo el RAG que creamos para él, y eso cambió completamente nuestra forma de testearlo.
